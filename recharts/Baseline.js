    ...
    return (
      <div className='App'>
        <ResponsiveContainer width={this.props.chartWidth} height={300}>
          <ComposedChart data={this.props.data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            <YAxis domain={['auto', 'auto']} hide />
            <CartesianGrid strokeDasharray='3 3' />
            <Tooltip />
            <Legend />
            <Line type='monotone' dataKey='value' stroke='#8884d8' isAnimationActive={false} dot={false} />
            <Area dataKey='baseline' fill='#8884d8' stroke='#8884d8' fillOpacity='0.6' legendType='line' isAnimationActive={false} dot={false} />
          </ComposedChart>
        </ResponsiveContainer>
      </div>
    );
